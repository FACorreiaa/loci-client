// Ported verbatim from north-web-app web/shared/ui/icon/brand_nvidia.templ:
// viewBox and path data are untouched. Not a Lucide icon — do not run it
// through any icon generator.
//
// Nvidia's mark in its fixed brand green.
import type { BrandIconProps } from "./props";
import { a11y } from "./props";

export default function Nvidia(props: BrandIconProps) {
  return (
    <svg
      class={props.class}
      {...a11y(props)}
