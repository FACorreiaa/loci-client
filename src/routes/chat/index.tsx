...
export default function ChatPage() {
  ...
  return (
    <div class="min-h-screen flex flex-col lg:flex-row relative overflow-hidden">
      ...
      {/* Main Chat Area */}
      {/* Main Chat Area — full-bleed Muse canvas. The header floats over the
          ...
          <div class="max-w-3xl mx-auto space-y-3 sm:space-y-4">
            ...
            <Show when={chat.isLoading()}>
              <div class="flex justify-start" aria-live="polite">
                <div class="max-w-[94%] rounded-[24px] bg-[var(--muse-agent-bubble)] px-4 py-2.5 text-[var(--muse-text)]">
